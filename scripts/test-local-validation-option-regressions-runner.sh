...
assert_not_contains "$help_duplicate_output" "Dry run summary:"
assert_not_contains "$help_duplicate_output" "Running shell syntax checks..."
assert_not_contains "$help_duplicate_output" "Running validate-local option regressions..."
assert_not_contains "$help_duplicate_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_duplicate_output" "Dry run summary:"
assert_not_contains "$help_alias_duplicate_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_duplicate_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_duplicate_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_mixed_duplicate_output" "Dry run summary:"
assert_not_contains "$help_mixed_duplicate_output" "Running shell syntax checks..."
assert_not_contains "$help_mixed_duplicate_output" "Running validate-local option regressions..."
assert_not_contains "$help_mixed_duplicate_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_first_with_unknown_output" "Running shell syntax checks..."
assert_not_contains "$help_first_with_unknown_output" "Running validate-local option regressions..."
assert_not_contains "$help_first_with_unknown_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_first_with_unknown_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_first_with_unknown_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_first_with_unknown_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_first_with_conflict_flags_output" "Running shell syntax checks..."
assert_not_contains "$help_first_with_conflict_flags_output" "Running validate-local option regressions..."
assert_not_contains "$help_first_with_conflict_flags_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_first_with_conflict_flags_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_first_with_conflict_flags_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_first_with_conflict_flags_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_first_with_dry_run_unknown_output" "Dry run summary:"
assert_not_contains "$help_alias_first_with_dry_run_unknown_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_first_with_dry_run_unknown_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_first_with_dry_run_unknown_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_first_with_dry_run_conflict_output" "Dry run summary:"
assert_not_contains "$help_alias_first_with_dry_run_conflict_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_first_with_dry_run_conflict_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_first_with_dry_run_conflict_output" "Running smoke-debug-emulator option regressions..."
...
assert_contains "$dry_run_duplicate_flag_output" "Would run shell syntax checks."
assert_contains "$dry_run_duplicate_flag_output" "Would run behavioral option regressions."
...
assert_contains "$dry_run_syntax_duplicate_flag_output" "Would run shell syntax checks."
...
assert_contains "$dry_run_behavior_duplicate_flag_output" "Would run behavioral option regressions."
...
assert_not_contains "$runtime_syntax_only_output" "Running validate-local AGP gate simulator regressions..."
...
assert_contains "$runtime_behavior_only_output" "Running validate-local AGP gate simulator regressions..."
...
assert_contains "$runtime_behavior_only_duplicate_flag_output" "Running validate-local AGP gate simulator regressions..."
...
assert_contains "$runtime_default_output" "Running validate-local AGP gate simulator regressions..."
