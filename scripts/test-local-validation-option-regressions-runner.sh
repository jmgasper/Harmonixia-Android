...
assert_not_contains "$help_output" "Running shell syntax checks..."
assert_not_contains "$help_output" "Running validate-local option regressions..."
assert_not_contains "$help_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_with_dry_run_output" "Dry run summary:"
assert_not_contains "$help_with_dry_run_output" "Running shell syntax checks..."
assert_not_contains "$help_with_dry_run_output" "Running validate-local option regressions..."
assert_not_contains "$help_with_dry_run_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_alias_with_dry_run_output" "Dry run summary:"
assert_not_contains "$help_alias_with_dry_run_output" "Running shell syntax checks..."
assert_not_contains "$help_alias_with_dry_run_output" "Running validate-local option regressions..."
assert_not_contains "$help_alias_with_dry_run_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$help_with_mode_output" "Running shell syntax checks..."
assert_not_contains "$help_with_mode_output" "Running validate-local option regressions..."
assert_not_contains "$help_with_mode_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_default_output" "Dry run summary: syntax regressions only."
assert_not_contains "$dry_run_default_output" "Dry run summary: behavioral regressions only."
...
assert_not_contains "$dry_run_duplicate_flag_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_duplicate_flag_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_duplicate_flag_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_syntax_output" "Dry run summary: syntax and behavioral regressions."
...
assert_not_contains "$dry_run_behavior_output" "Dry run summary: syntax and behavioral regressions."
assert_not_contains "$dry_run_behavior_output" "Dry run summary: syntax regressions only."
...
assert_not_contains "$dry_run_behavior_reversed_output" "Running validate-local option regressions..."
...
runtime_syntax_only_duplicate_flag_output="$(run_expect_exit 0 --syntax-only --syntax-only)"
...
assert_not_contains "$conflict_output" "Running shell syntax checks..."
assert_not_contains "$conflict_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$conflict_behavior_first_output" "Running shell syntax checks..."
assert_not_contains "$conflict_behavior_first_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_behavior_first_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$conflict_duplicate_syntax_output" "Running shell syntax checks..."
assert_not_contains "$conflict_duplicate_syntax_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_duplicate_syntax_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$conflict_duplicate_behavior_output" "Running shell syntax checks..."
assert_not_contains "$conflict_duplicate_behavior_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_duplicate_behavior_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$conflict_behavior_first_duplicate_behavior_output" "Running shell syntax checks..."
assert_not_contains "$conflict_behavior_first_duplicate_behavior_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_behavior_first_duplicate_behavior_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_output" "Dry run mode enabled."
assert_not_contains "$dry_run_conflict_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_behavior_first_output" "Dry run mode enabled."
assert_not_contains "$dry_run_conflict_behavior_first_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_behavior_first_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_behavior_first_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_behavior_first_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_reversed_output" "Dry run mode enabled."
assert_not_contains "$dry_run_conflict_reversed_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_reversed_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_reversed_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_reversed_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_mixed_order_output" "Dry run mode enabled."
assert_not_contains "$dry_run_conflict_mixed_order_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_mixed_order_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_mixed_order_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_mixed_order_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_duplicate_behavior_output" "Dry run mode enabled."
assert_not_contains "$dry_run_conflict_duplicate_behavior_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_duplicate_behavior_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_duplicate_behavior_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_duplicate_behavior_output" "Running smoke-debug-emulator option regressions..."

dry_run_conflict_duplicate_syntax_output="$(run_expect_exit 1 --dry-run --syntax-only --syntax-only --behavior-only)"
assert_contains "$dry_run_conflict_duplicate_syntax_output" "Cannot combine --syntax-only with --behavior-only."
assert_contains "$dry_run_conflict_duplicate_syntax_output" "Usage:"
...
assert_not_contains "$dry_run_conflict_duplicate_syntax_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_duplicate_syntax_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_duplicate_syntax_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_duplicate_both_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_duplicate_both_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_duplicate_both_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$conflict_before_help_output" "Running shell syntax checks..."
assert_not_contains "$conflict_before_help_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_before_help_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$conflict_before_help_alias_output" "Running shell syntax checks..."
assert_not_contains "$conflict_before_help_alias_output" "Running validate-local option regressions..."
assert_not_contains "$conflict_before_help_alias_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_before_help_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_before_help_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_before_help_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_before_help_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$dry_run_conflict_before_help_alias_output" "Dry run summary:"
assert_not_contains "$dry_run_conflict_before_help_alias_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_conflict_before_help_alias_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_conflict_before_help_alias_output" "Running smoke-debug-emulator option regressions..."
...
assert_not_contains "$unknown_argument_output" "Running shell syntax checks..."
assert_not_contains "$unknown_argument_output" "Running validate-local option regressions..."
assert_not_contains "$unknown_argument_output" "Running smoke-debug-emulator option regressions..."
...
assert_contains "$unknown_before_help_output" "Usage:"
assert_not_contains "$unknown_before_help_output" "Running shell syntax checks..."
assert_not_contains "$unknown_before_help_output" "Running validate-local option regressions..."
assert_not_contains "$unknown_before_help_output" "Running smoke-debug-emulator option regressions..."
...
assert_contains "$unknown_before_help_alias_output" "Usage:"
assert_not_contains "$unknown_before_help_alias_output" "Running shell syntax checks..."
assert_not_contains "$unknown_before_help_alias_output" "Running validate-local option regressions..."
assert_not_contains "$unknown_before_help_alias_output" "Running smoke-debug-emulator option regressions..."
...
assert_contains "$dry_run_unknown_argument_output" "Usage:"
assert_not_contains "$dry_run_unknown_argument_output" "Dry run mode enabled."
assert_not_contains "$dry_run_unknown_argument_output" "Dry run summary:"
assert_not_contains "$dry_run_unknown_argument_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_unknown_argument_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_unknown_argument_output" "Running smoke-debug-emulator option regressions..."
...
assert_contains "$dry_run_unknown_before_help_output" "Usage:"
assert_not_contains "$dry_run_unknown_before_help_output" "Dry run mode enabled."
assert_not_contains "$dry_run_unknown_before_help_output" "Dry run summary:"
assert_not_contains "$dry_run_unknown_before_help_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_unknown_before_help_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_unknown_before_help_output" "Running smoke-debug-emulator option regressions..."
...
assert_contains "$dry_run_unknown_before_help_alias_output" "Usage:"
assert_not_contains "$dry_run_unknown_before_help_alias_output" "Dry run mode enabled."
assert_not_contains "$dry_run_unknown_before_help_alias_output" "Dry run summary:"
assert_not_contains "$dry_run_unknown_before_help_alias_output" "Running shell syntax checks..."
assert_not_contains "$dry_run_unknown_before_help_alias_output" "Running validate-local option regressions..."
assert_not_contains "$dry_run_unknown_before_help_alias_output" "Running smoke-debug-emulator option regressions..."
