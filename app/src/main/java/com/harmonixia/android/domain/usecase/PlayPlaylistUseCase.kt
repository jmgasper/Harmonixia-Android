    ...
    suspend operator fun invoke(
        ...
        return runCatching {
            ...
            if (tracksOverride != null && tracksOverride.isEmpty()) {
                throw IllegalStateException(context.getString(R.string.playback_error_playlist_has_no_tracks))
            }
                ...
                try {
                    ...
                    if (fallbackTracks.isEmpty()) {
                        return@withContext Result.failure(
                            IllegalStateException(context.getString(R.string.playback_error_playlist_has_no_tracks))
                        )
                    }
