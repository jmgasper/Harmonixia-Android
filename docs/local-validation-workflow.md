...
- Run all option-parsing regression checks:
  ...
  - UI literal scanner coverage currently includes literal detection for `Text("...")`, `BasicText("...")`, `text = "..."`, `contentDescription = "..."`, `AnnotatedString("...")`, `AnnotatedString(text = "...")`, and `append("...")` / `appendLine("...")` inside `buildAnnotatedString { ... }`.
